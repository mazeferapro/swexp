...
function SWExp.Armor.ApplyArmorSpeed(pPlayer)
    ...
    local speedBonus = pPlayer.SWExp_SpeedBonus or 0
    -- Прокачка уменьшает штраф к скорости; зажим 0.3..1 чтобы не уйти в ноль/суперскорость
    local mult = math.Clamp(1 - (penalty * 0.4) + speedBonus, 0.3, 1)
