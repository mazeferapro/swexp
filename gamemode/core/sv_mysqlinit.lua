...
-- Создание таблиц при подключении к БД
...
hook.Add('DatabaseInitialized', 'SWExp::CreateTables', function()
    ...
    MySQLite.query([[
        ...
        -- characters (ДОБАВЛЕНА КОЛОНКА model)
        MySQLite.query([[
            ...
            -- inventory (НОВАЯ СТРУКТУРА СЕТКИ)
            MySQLite.query([[
                        ...
                        MySQLite.query([[
                            ...
                            MySQLite.query([[
                                ...
                                MySQLite.query([[
                                    ...
                                    print('[SWExp] Все таблицы БД успешно инициализированы.')
                                end)
