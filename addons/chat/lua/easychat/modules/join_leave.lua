...
if SERVER then
	local EC_JOIN_LEAVE = CreateConVar("easychat_joinleave_msg", "0", FCVAR_ARCHIVE, "Enables or disables join/leave messages")
...
if CLIENT then
	...
	net.Receive(TAG, function()
		...
		if not reason then
			chat.AddText(Color(200, 200, 200), name, Color(175, 175, 175), " (" .. networkid .. ") ", Color(127, 255, 127), "подключился")
		else
			chat.AddText(Color(200, 200, 200), name, Color(175, 175, 175), " (" .. networkid .. ") ", Color(255, 127, 127), "вышел", Color(175, 175, 175), " (" .. reason .. ")")
		end
	end)
end
