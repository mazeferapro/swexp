...
if CLIENT then
	...
	local function open_chatbox(is_secondary, requested_mode)
		...
		if EC_GLOBAL_ON_OPEN:GetBool() and active_tab.Name == "Общий" then
	...
	function EasyChat.Init()
		...
		do
			...
			EasyChat.AddTab("Общий", global_tab, "icon16/comments.png")
			EasyChat.SetFocusForOn("Общий", global_tab.TextEntry)
		...
		hook.Add("OnPauseMenuShow", "DisableMenu", function()
			if EasyChat.IsOpened() then return false end
		end)
